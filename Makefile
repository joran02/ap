...
EXTRA_LDFLAGS          = -L/root/libmysql/lib64 -L/root/libboost/lib -L/root/libopenssl3/lib  -lmysqlcppconn-static  -lssl -lcrypto  -lboost_thread -lboost_system -lpthread -ldl

# Specify the include dirs, e.g. "-I/usr/include/mysql -I./include -I/usr/include -I/usr/local/include".
INCLUDE                = -I/root/libmysql/include -I/root/libmysql/include/jdbc -I/root/libboost/include -I/root/libopenssl3/include  -I/root/taian/lib/libjpeg/include -I/root/taian/lib/log4cpp/include
